...
``` r
CWMetadata_Alpha %>%
  ggplot(aes(x =Propor_TotalAntiFungal , y = observed_otus)) +
  geom_point(aes(alpha = 0.5,color = FrogSpecies, shape = CaptiveWild2)) +
...
``` r
CWMetadata_Alpha %>%
  ggplot(aes(x =Propor_TotalAntiFungal , y = ExpShannon)) +
  geom_point(aes(alpha = 0.5,color = FrogSpecies, shape = CaptiveWild2)) +
  geom_smooth(method=lm, level = 0.95, color = "black") +
  ggpubr::stat_cor(method = "kendall")+
  theme(axis.text.x = element_text(angle = 90)) +
...
``` r
CWMetadata_Alpha %>%
  ggplot(aes(x =Propor_TotalAntiFungal , y = log10(ExpShannon))) +
  geom_point(aes(alpha = 0.5,color = FrogSpecies, shape = CaptiveWild2)) +
  geom_smooth(method=lm, level = 0.95, color = "black") +
 ggpubr::stat_cor(method = "kendall")+
  theme(axis.text.x = element_text(angle = 90)) +
...
``` r
AtelopusMeso_Full = read_tsv("atelopusdata/Metadata_ATVAonly.txt")
```
...
AtelopusMeso_Full %>%
  filter(SAMPLE=="field") %>%
  filter(!infected=="NA") %>%
  ggplot(aes(x=as.factor(infected), y=observed_features)) +
  geom_boxplot(aes(color = as.factor(infected)))+
  geom_point(aes(alpha=0.5,size = TotalAntiFungal))+
  theme_q2r() +
  ggtitle("sOTUs")+
...
AtelopusMeso_Full %>%
  filter(SAMPLE=="field") %>%
  ggplot(aes(x=lifeStage, y=SVL)) +
  geom_boxplot()+
  geom_point(aes(alpha=0.5,color = as.factor(infected)))+
  theme_q2r() +
  ggtitle("SVL") +
  guides(alpha = "none",shape = "none",size = "none")
```
...
AtelopusMeso_Full %>%
  filter(SAMPLE=="field") %>%
  filter(!infected=="NA") %>%
  ggplot(aes(x=SVL, y=observed_features)) +
  geom_point(aes(color = as.factor(infected),shape = lifeStage,size = TotalAntiFungal))+
  geom_smooth(method = "lm")+
  ggpubr::stat_cor(method = "kendall",label.x = 50)+
  theme_q2r() +
  ggtitle("sOTUs (all)")
```
